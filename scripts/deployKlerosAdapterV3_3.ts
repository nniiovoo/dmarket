// Deploy KlerosV2DisputeAdapterV3_3 on Arbitrum Sepolia (or any network with a
// configured v3.3 marketplace). Uses the real Kleros V2 KlerosCore on
...
//
// Usage:
//   npx hardhat run scripts/deployKlerosAdapterV3_3.ts --network arbitrumSepolia
...
async function main() {
  ...
  console.log("Deploying KlerosV2DisputeAdapterV3_3");
  console.log(`  network:        ${networkName}`);
  console.log(`  deployer:       ${await deployer.getAddress()}`);
  console.log(`  v3.3 mkt:       ${marketplaceAddress}`);
  ...
  console.log("\n[2/2] Deploying KlerosV2DisputeAdapterV3_3...");
  ...
  console.log(`V3_3_${upper}_KLEROS_ADAPTER_ADDRESS=${adapterAddress}`);
  console.log(`NEXT_PUBLIC_V3_3_${upper}_KLEROS_ADAPTER_ADDRESS=${adapterAddress}`);
  console.log("--- End paste block ---");
  console.log("");
  console.log("Next step: transfer marketplace ownership to the adapter:");
  console.log(`  npx hardhat run scripts/migrateV3_3MarketplaceToKlerosAdapter.ts --network ${networkName}`);
